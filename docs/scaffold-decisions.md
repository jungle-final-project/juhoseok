...
이 문서는 팀원이 “왜 이렇게 만들어졌는지”를 빠르게 이해하기 위한 결정사항 모음입니다. 기획안 자체를 대체하지 않으며, 현재 프로토타입에서 함께 지켜야 할 범위와 예외만 정리합니다.

## 이번 범위

이번 저장소는 완성 서비스가 아니라 5인 병렬 개발 착수용 프로토타입입니다. 아래 항목을 먼저 제공합니다.
...
아래 항목은 지금 스캐폴드에서 완성하지 않습니다. 담당자 Sprint 작업이나 이후 고도화 단계에서 다룹니다.
